    ...
    return (
        <div className="relative w-full py-4">
            ...
            >
                ...
                <button
                    type="button"
                    className="absolute top-1/2 -translate-y-1/2 left-0 z-30 hidden sm:flex items-center justify-center h-full px-1 sm:px-2 cursor-pointer group focus:outline-none"
                    onClick={prevSlide}
                >
                ...
                <button
                    type="button"
                    className="absolute top-1/2 -translate-y-1/2 right-0 z-30 hidden sm:flex items-center justify-center h-full px-1 sm:px-2 cursor-pointer group focus:outline-none"
                    onClick={nextSlide}
                >
                    <span className="inline-flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-(--card-bg) border border-(--card-border) shadow-md group-hover:bg-(--card-bg-hover) transition-all">
